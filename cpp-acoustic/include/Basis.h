...
void xytors(VectorXd x, VectorXd y, VectorXd &r, VectorXd &s);

// 3D
void rsttoabc(VectorXd r,  VectorXd s,  VectorXd t,  VectorXd &a, VectorXd &b, VectorXd &c);
...
void xyztorst(VectorXd x, VectorXd y, VectorXd z, VectorXd &r, VectorXd &s, VectorXd &t);
